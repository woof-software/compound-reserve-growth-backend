...
export class Migration1757580580561 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "daily_aggregation" ALTER COLUMN "avgRatio" TYPE numeric(78,0)`,
    );
    await queryRunner.query(
      `ALTER TABLE "daily_aggregation" ALTER COLUMN "minRatio" TYPE numeric(78,0)`,
    );
    await queryRunner.query(
      `ALTER TABLE "daily_aggregation" ALTER COLUMN "maxRatio" TYPE numeric(78,0)`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "daily_aggregation" ALTER COLUMN "maxRatio" TYPE numeric(78,8)`,
    );
    await queryRunner.query(
      `ALTER TABLE "daily_aggregation" ALTER COLUMN "minRatio" TYPE numeric(78,8)`,
    );
    await queryRunner.query(
      `ALTER TABLE "daily_aggregation" ALTER COLUMN "avgRatio" TYPE numeric(78,8)`,
    );
