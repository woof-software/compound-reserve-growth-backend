...
export class Migration1757581727923 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "daily_aggregation" ALTER COLUMN "cap" TYPE numeric(78,8)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "daily_aggregation" ALTER COLUMN "cap" TYPE numeric(78,0)`);
